...
public:
    ...
    void setupUi(QWidget *Log)
    {
        ...
        Log->resize(1348, 807);
        layoutWidget = new QWidget(Log);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(0, 10, 1331, 781));
        ...
        labelStartTime = new QLabel(layoutWidget);
        ...
        labelEndTime = new QLabel(layoutWidget);
        ...
        btnRetrieve = new QPushButton(layoutWidget);
        ...
        widgetOut2 = new QWidget(layoutWidget);
        ...
        widgetOut1 = new QWidget(layoutWidget);
        ...
        widgetIn1 = new QWidget(layoutWidget);
        ...
        tableWidgetLog = new QTableWidget(layoutWidget);
        ...
        widgetIn3 = new QWidget(layoutWidget);
        ...
        widgetIn4 = new QWidget(layoutWidget);
        ...
        widgetOut3 = new QWidget(layoutWidget);
        ...
        widgetOut4 = new QWidget(layoutWidget);
        ...
        labelLogCount = new QLabel(layoutWidget);
        ...
        labelRecs = new QLabel(layoutWidget);
        ...
        labelPageCount = new QLabel(layoutWidget);
        ...
        labelPage = new QLabel(layoutWidget);
        ...
        btnFirst = new QPushButton(layoutWidget);
