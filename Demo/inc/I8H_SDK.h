...
/************************************************************************
			   查找文件和日志函数返回值宏定义   
*************************************************************************/	
#define I8H_FINDFILE_SUCCESS								1000 //!获得文件信息
#define I8H_FINDFILE_NOFIND									1001 //!没有文件
#define I8H_FINDFILE_ISFINDING								1002 //!正在查找文件
#define I8H_FINDFILE_NOMOREFILE								1003 //!查找文件时没有更多的文件
#define I8H_FINDFILE_EXCEPTION								1004 //!查找文件时异常
...
typedef struct
{
	...
	BYTE byVer; 											//!1:DVR_GO_AHEAD    2:NVR1.0_GO_AHEAD   3:IPC_GO_AHEAD   4:DEC_GO_AHEAD  5:NVR2.0_GO_AHEAD   6:DVR_NGINX    7:NVR1.0_NGINX   8:IPC_NGINX  9:DEC_NGINX 10:NVR2.0_NGINX 
	BYTE byRes[63];											//!保留
...
typedef struct
{
	...
	BYTE bOvfs_IPC:1;       					//!bit0:是否为OVFS架构 
	BYTE bRes:7;       							//!bit1~bit7:保留
	BYTE byRes[4] ;	
